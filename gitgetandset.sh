echo "Make sure you are in the correct directory for your repository"
...
echo "To restore github got into the folder and type ./gitpush.sh. you will need your github login and password."
